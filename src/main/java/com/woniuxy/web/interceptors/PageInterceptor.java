package com.woniuxy.web.interceptors;
...
import com.woniuxy.util.page.Dialect;
import com.woniuxy.util.page.DialectFactory;
...
public class PageInterceptor implements Interceptor{
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		//执行的条件和参数都放在metaObject中，需要从metaObject中进行获取
